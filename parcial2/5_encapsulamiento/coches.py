...
# El encapsulamiento o visibilidad es importante por que a traves de el es 
#posible que python como va a utilizar y manipular los atribiutos y metodos de la clase
...
#Nota 2 :para utilizar un metodo privado es necessario usarlo dentro de un metodo publico
