...
del objeto al crearlo, es el primer metodo que se ejecuta al crear el objeto y se manda llamar automaticamente al crearlo, es decir ste metodo puede recibir parametros al momento de crear el objeto 
 
cuando se crea un metodo constructor se utiliza la funcion init(), para que se llame automaticamente cada vez que se utiliza 
la clase para crear un nuevo objeto 



El self es un parametro es una referencia a la instancia actual de la clae y se utiliza para acceder a variables que pertenecen a la clase

No es necesario que tenga nombre self, puedes llamarlo como quieras, pero tiene que ser el 
