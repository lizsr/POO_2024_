#Ciclo while:es una Estructura iterativa que se ejecuta x veces 
#siempre ycuando la condicion se cumpla y se seguira ejecutando tantas veces como sea True la condicion
